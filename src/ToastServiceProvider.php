...
class ToastServiceProvider extends PackageServiceProvider
{
    ...
    {
        RouteFacade::get('/toast/tall-toast.js', [JavaScriptAssets::class, 'source']);
        RouteFacade::get('/toast/tall-toast.js.map', [JavaScriptAssets::class, 'maps']);
